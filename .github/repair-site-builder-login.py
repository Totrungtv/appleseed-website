...
stable = '''name: Deploy Apple Seed to GitHub Pages
...
'''
Path('.github/workflows/deploy-pages.yml').write_text(stable, encoding='utf-8')
print('patched site-builder.html and restored stable deploy workflow')
