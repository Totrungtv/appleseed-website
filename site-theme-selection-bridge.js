/* APPLE SEED SITE BUILDER LOGIN + THEME BRIDGE V23 */
(function(){
'use strict';
...
/* THEME: published draft is authoritative; mirror it into legacy storage because the native Builder renderer still reads storage. */
