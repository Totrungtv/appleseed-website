/* Apple Seed Mobile Hero Final V2
 * Mobile-only layout correction. Forces the slider to use the viewport as its layout reference.
 */
(function(){
  'use strict';

  var STYLE_ID='apple-seed-mobile-hero-final-v2-css';
...
@media (max-width:760px){
  ...
  #apple-seed-premium-home .as3-stage.apple-seed-slider-active{
  ...
  #apple-seed-premium-home .apple-seed-hero-slider{
    ...
    border-radius:16px!important;overflow:hidden!important;z-index:100!important;
  }
